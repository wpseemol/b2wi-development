            ...
            <div className="group overflow-hidden bg-white dark:bg-transparent rounded shadow-2xl text-slate-500 shadow-slate-200 dark:shadow-black border border-neutral-300/20 min-h-[300px]">
                <div className="relative md:p-6 p-2">
                    <figure className="relative z-10">
                        ...
                        <figcaption className="flex items-center gap-4 p-6 pt-2 text-sm text-primary dark:text-blue-200/85">
                    ...
                    <svg
                        aria-hidden="true"
                        className="absolute z-0 h-16 left-6 top-6 group-hover:scale-110 duration-200"
                        viewBox="0 0 17 12"
                        fill="none"
                    ...
                    >
                        <path
                            ...
                            className="fill-primary/20 dark:fill-neutral-200/5"
                        />
                    </svg>
                </div>
            </div>
