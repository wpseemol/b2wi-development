...
export default function TestimonialContent({
    ...
    return (
        <>
            ...
            <div className="overflow-hidden bg-white dark:bg-transparent rounded shadow-2xl text-slate-500 shadow-slate-200 dark:shadow-black border border-neutral-300/20 min-h-[300px]">
                <div className="relative p-6">
                    ...
                    <svg
                        ...
                        <path
                            ...
                            className="fill-primaryColor/20"
                        />
                    </svg>
                </div>
            </div>
            {/*      <!-- End Elevated simple base sized testimonial --> */}
        </>
    );
}
