...
export default function Header() {
    return (
        <header className="">
            ...
            <section className="bg-gradient-to-r from-[#2d3544] to-[#0165ac] border-y border-primaryColor md:py-5 py-4 dark:bg-gradient-to-r dark:from-[#224a94] dark:to-[#17174b] md:px-3 px-2 ">
                <NavMenu />
            </section>
        </header>
    );
